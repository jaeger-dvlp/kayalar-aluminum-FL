...
import QualityBanner from '@/public/assets/img/quality.webp';
  ...
  return (
    <>
      ...
      <main className="m-0 flex min-h-screen flex-col items-center justify-start gap-0 p-0">
        <BreadCrumbs
          title="quality.title"
          path={[{ name: 'navbar.quality', href: '/quality' }]}
        />
