...
import RequestQuoteForm from '@/components/forms/RequestQuote.Form';
          ...
          <section className="max-w-theme flex w-full flex-col items-start justify-start gap-5 px-5">
            <h2 className="flex flex-col items-start justify-start gap-1 text-3xl font-extrabold text-white lg:text-6xl">
              ...
              >
                ...
                {t('request-quote.heading.mini')}
              </span>
              {t('request-quote.heading.title')}
            </h2>
            <p className="max-w-2xl text-sm text-neutral-400 lg:text-lg">
              {t('request-quote.content.description')}
            </p>
          </section>
        </section>
        <section className="flex w-full flex-col items-center justify-start border-y border-stone-700 bg-stone-900 px-0 py-20">
          <section className="max-w-theme grid h-full w-full grid-cols-6 place-content-stretch place-items-start gap-10 px-5">
            <section className="col-span-full m-0 flex h-full w-full p-0 lg:col-span-4">
              <RequestQuoteForm />
            </section>
            <section className="col-span-full grid w-full grid-cols-1 place-content-stretch place-items-start gap-10 lg:col-span-2">
              <section className="flex h-full w-full flex-row items-start justify-start gap-5 border border-stone-700 bg-stone-800 p-5">
                <span className="flex aspect-square items-center justify-center border border-stone-700 bg-stone-900 p-3">
                ...
                <section className="flex flex-col items-start justify-start gap-2 pt-2.5">
                  ...
                  <a
                    ...
                    className="text-primary mt-2 flex items-center justify-start gap-2 text-xs hover:underline"
                  >
              ...
              <section className="flex h-full w-full flex-row items-start justify-start gap-5 border border-stone-700 bg-stone-800 p-5">
                ...
                <section className="flex flex-col items-start justify-start gap-2 pt-2.5">
                  ...
                  <a
                    ...
                    className="text-xs text-neutral-400 transition-all duration-200 hover:text-white hover:underline"
                  >
                    +90 (212) 485 24 28
                  </a>
                  <a
